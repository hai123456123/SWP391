            ...
            <div id="top-header">
                <div class="container">
                    <ul class="header-links pull-left">
                        ...
                        <li><a href="#"><i class="fa fa-envelope-o"></i> HoLaTechSE1803@gmail.com</a></li>

                    </ul>
                    <ul class="header-links pull-right">
                        <c:if test="${sessionScope.acc.roleId==1}">
                            <li><a href="productmanage.jsp"> Product</a></li>
                            </c:if>
                        ...
                        <c:if test="${sessionScope.acc!=null}">
                            <li><a href="#"><i class="fa fa-user-o"></i> ${sessionScope.acc.fullName}</a></li>
