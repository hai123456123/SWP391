                        ...
                        <div class="card text-white card-short" style="border-radius: 1rem;">
                            <div class="card-body p-5 text-center">
                                <div class="mb-md-5 mt-md-4 pb-5">
                                    <h2 class="text-muted">Forget Password</h2><br/><br/>
                                    <center>
                                    ...
                                    <form action="register" method="post">
                                        ...
                                        <button data-mdb-button-init data-mdb-ripple-init class="btn custom-btn btn-lg px-5" type="submit">Register</button>
                                    </form>
